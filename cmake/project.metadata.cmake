...
set(DEX_PROJECT_NAME "kiirodex-desktop")
set(DEX_DISPLAY_NAME "KiiroDEX Desktop")
set(DEX_MAINTENANCE_TOOL_NAME "KiiroDEX Desktop Maintenance Tool")
set(DEX_COMPANY "Kirrocoin")
set(DEX_WEBSITE "https://kiirocoin.org/")
set(DEX_VERSION "0.6.1")
set(DEX_SUPPORT_PAGE "https://support.komodoplatform.com/support/home")
set(DEX_DISCORD "https://discord.gg/yFbbrtPscq")
set(DEX_TWITTER "https://twitter.com/kiirocoin")
set(DEX_PRIMARY_COIN "KIIRO")                                                         ## Main coin of the DEX, will be enabled by default and will be the default left ticker for trading
...
set(DEX_REPOSITORY_NAME "kiiroDEX-desktop")
set(DEX_CHECKSUM_API_URL "https://komodo.earth/static/checksum.json")
if (APPLE)
    set(DEX_APPDATA_FOLDER "KiiroDEX Desktop")
else ()
    set(DEX_APPDATA_FOLDER "kiirodex_qt")
endif ()
if (UNIX AND NOT APPLE)
    set(DEX_LINUX_APP_ID "kiirodex.desktop")
endif ()
